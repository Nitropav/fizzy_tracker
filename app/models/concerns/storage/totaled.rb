module Storage::Totaled
  ...
  def materialize_storage
    ...
    total.with_lock do
      latest_entry_id = latest_storage_entry_id
  ...
  def reconcile_storage
    cursor_before = latest_storage_entry_id
    real_bytes = calculate_real_storage_bytes
    cursor_after = latest_storage_entry_id
  ...
  private
    ...
    def latest_storage_entry_id
      storage_entries.reorder(id: :desc).pick(:id)
    end
